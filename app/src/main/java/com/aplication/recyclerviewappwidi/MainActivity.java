package com.aplication.recyclerviewappwidi;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private void prepareMahasiswaData() {
            ...
            mahasiswaList.add(new Mahasiswa("Widi Anggraeni Puspitasari","311710603","089612249216"));
            mahasiswaList.add(new Mahasiswa("Dimas Panji Adityantoro","311710056","085632178429"));
            mahasiswaList.add(new Mahasiswa("Afif Fathurohman","311710477","0857190765889"));
            mahasiswaList.add(new Mahasiswa("Siti Fazriah","311710433","0857190764589"));
        }
